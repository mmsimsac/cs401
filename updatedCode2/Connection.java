...
class Connection extends Thread
{
    ...
    public void eventHandler(Packet p, Server s, ArrayList<Connection> connectionList)
    {
        ...
        switch (event_type)
        {
            ...
            case 5: // client wants to quit
                ...
                s.numClients--;
                System.out.println("Total Registered Clients: " + s.numClients);
    ...
    public void serverCloseConnection() throws IOException { //server wants to quit
        Packet closeP = new Packet();
        closeP.event_type = 6;
        outputStream.writeObject(closeP);
        outputStream.close();
        inputStream.close();
        socket.close();
        System.out.println("Packet Sent\nClosed clientSocket");
